...
Hello, this a Summary of the NZ LTPP programmes data to 2019!  
  
The aim of the site is to display the data from the NZ LTPP programme grapically and show case the freeware statistical software used to do this.
...
The site is delibrately doing this as part of "Data Science" approach to make analysis accessible and reproducible.
    
All the code is available for download at Github and a copy of the database is available from the NZTA. 
  
The site contains only 8 pages but that contain a lot of detail as the short decriptions below will explain.
   
(@) The Home page - ie this page, contains the pupose and the structure of the site  
