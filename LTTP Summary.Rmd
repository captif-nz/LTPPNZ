...
```{r plot Rutting10m SH Site , fig.height=40, fig.width=12, echo=TRUE}
...
```{r plot Rutting10m LA Site , fig.height=20, fig.width=12, echo=TRUE}
...
```{r plot Roughness10m SH Site , fig.height=40, fig.width=12, echo=TRUE}
...
```{r plot Roughness10m LA Site , fig.height=40, fig.width=12, echo=TRUE}
...
```{r plot SH Texture10m , fig.height=20, fig.width=12, echo=TRUE}
...
```{r plot LA Texture10m , fig.height=20, fig.width=12, eval = FALSE}
